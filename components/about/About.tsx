    ...
    <div className="shortAbout">
      ...
      <div className="shortAboutContent" >
        ...
        <p>
          ...
          I&#x27;m Mehboob Alam, a passionate software engineering student at the University of Engineering and Technology (UET) Lahore. I&abos;m currently pursuing my degree and gaining hands-on experience in software development, with a focus on MERN Stack technologies.
          <br />
