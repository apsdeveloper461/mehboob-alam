...
const Service = () => {
  ...
  return (
    <section id='services' className='px-8 md:px-12  md:mr-16 lg:mr-0'>
      ...
      {serviceCards &&
        <>
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:mr-0  items-center  gap-6 md:gap-16 ">
            ...
            <div className="cursor-pointer hover:z-40 hover:scale-105 md:z-30 lg:z-0 lg:scale-100 md:scale-105" ><ServiceCard key={'servicecard2'} serviceCardData={serviceCards[1]}/></div>
